...
class SolverParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional float dvf_threshold = 42 [default = 0];
  inline bool has_dvf_threshold() const;
  inline void clear_dvf_threshold();
  static const int kDvfThresholdFieldNumber = 42;
  inline float dvf_threshold() const;
  inline void set_dvf_threshold(float value);

  // optional int32 dvf_iter = 43 [default = 10000];
  inline bool has_dvf_iter() const;
  inline void clear_dvf_iter();
  static const int kDvfIterFieldNumber = 43;
  inline ::google::protobuf::int32 dvf_iter() const;
  inline void set_dvf_iter(::google::protobuf::int32 value);

  // optional string dvf_prefix = 44 [default = "./"];
  inline bool has_dvf_prefix() const;
  inline void clear_dvf_prefix();
  static const int kDvfPrefixFieldNumber = 44;
  inline const ::std::string& dvf_prefix() const;
  inline void set_dvf_prefix(const ::std::string& value);
  inline void set_dvf_prefix(const char* value);
  inline void set_dvf_prefix(const char* value, size_t size);
  inline ::std::string* mutable_dvf_prefix();
  inline ::std::string* release_dvf_prefix();
  inline void set_allocated_dvf_prefix(::std::string* dvf_prefix);
 ...
 private:
  ...
  inline void set_has_dvf_threshold();
  inline void clear_has_dvf_threshold();
  inline void set_has_dvf_iter();
  inline void clear_has_dvf_iter();
  inline void set_has_dvf_prefix();
  inline void clear_has_dvf_prefix();
  ...
  float dvf_threshold_;
  ::std::string* dvf_prefix_;
  static ::std::string* _default_dvf_prefix_;
  ::google::protobuf::int32 dvf_iter_;
...
// optional float dvf_threshold = 42 [default = 0];
inline bool SolverParameter::has_dvf_threshold() const {
  return (_has_bits_[0] & 0x00004000u) != 0;
}
inline void SolverParameter::set_has_dvf_threshold() {
  _has_bits_[0] |= 0x00004000u;
}
inline void SolverParameter::clear_has_dvf_threshold() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void SolverParameter::clear_dvf_threshold() {
  dvf_threshold_ = 0;
  clear_has_dvf_threshold();
}
inline float SolverParameter::dvf_threshold() const {
  return dvf_threshold_;
}
inline void SolverParameter::set_dvf_threshold(float value) {
  set_has_dvf_threshold();
  dvf_threshold_ = value;
}

// optional int32 dvf_iter = 43 [default = 10000];
inline bool SolverParameter::has_dvf_iter() const {
  return (_has_bits_[0] & 0x00008000u) != 0;
}
inline void SolverParameter::set_has_dvf_iter() {
  _has_bits_[0] |= 0x00008000u;
}
inline void SolverParameter::clear_has_dvf_iter() {
  _has_bits_[0] &= ~0x00008000u;
}
inline void SolverParameter::clear_dvf_iter() {
  dvf_iter_ = 10000;
  clear_has_dvf_iter();
}
inline ::google::protobuf::int32 SolverParameter::dvf_iter() const {
  return dvf_iter_;
}
inline void SolverParameter::set_dvf_iter(::google::protobuf::int32 value) {
  set_has_dvf_iter();
  dvf_iter_ = value;
}

// optional string dvf_prefix = 44 [default = "./"];
inline bool SolverParameter::has_dvf_prefix() const {
  return (_has_bits_[0] & 0x00010000u) != 0;
}
inline void SolverParameter::set_has_dvf_prefix() {
  _has_bits_[0] |= 0x00010000u;
}
inline void SolverParameter::clear_has_dvf_prefix() {
  _has_bits_[0] &= ~0x00010000u;
}
inline void SolverParameter::clear_dvf_prefix() {
  if (dvf_prefix_ != _default_dvf_prefix_) {
    dvf_prefix_->assign(*_default_dvf_prefix_);
  }
  clear_has_dvf_prefix();
}
inline const ::std::string& SolverParameter::dvf_prefix() const {
  return *dvf_prefix_;
}
inline void SolverParameter::set_dvf_prefix(const ::std::string& value) {
  set_has_dvf_prefix();
  if (dvf_prefix_ == _default_dvf_prefix_) {
    dvf_prefix_ = new ::std::string;
  }
  dvf_prefix_->assign(value);
}
inline void SolverParameter::set_dvf_prefix(const char* value) {
  set_has_dvf_prefix();
  if (dvf_prefix_ == _default_dvf_prefix_) {
    dvf_prefix_ = new ::std::string;
  }
...
inline void SolverParameter::set_dvf_prefix(const char* value, size_t size) {
  set_has_dvf_prefix();
  if (dvf_prefix_ == _default_dvf_prefix_) {
    dvf_prefix_ = new ::std::string;
  }
  dvf_prefix_->assign(reinterpret_cast<const char*>(value), size);
}
inline ::std::string* SolverParameter::mutable_dvf_prefix() {
  set_has_dvf_prefix();
  if (dvf_prefix_ == _default_dvf_prefix_) {
    dvf_prefix_ = new ::std::string(*_default_dvf_prefix_);
  }
  return dvf_prefix_;
}
inline ::std::string* SolverParameter::release_dvf_prefix() {
  clear_has_dvf_prefix();
  if (dvf_prefix_ == _default_dvf_prefix_) {
    return NULL;
  } else {
    ::std::string* temp = dvf_prefix_;
    dvf_prefix_ = const_cast< ::std::string*>(_default_dvf_prefix_);
    return temp;
  }
}
inline void SolverParameter::set_allocated_dvf_prefix(::std::string* dvf_prefix) {
  if (dvf_prefix_ != _default_dvf_prefix_) {
    delete dvf_prefix_;
  }
  if (dvf_prefix) {
    set_has_dvf_prefix();
    dvf_prefix_ = dvf_prefix;
  } else {
    clear_has_dvf_prefix();
    dvf_prefix_ = const_cast< ::std::string*>(_default_dvf_prefix_);
  }
